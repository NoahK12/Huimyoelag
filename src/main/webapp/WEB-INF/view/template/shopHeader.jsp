...
<div class="navheader">
	<div class="headerInner">
		<div class="gnb-bar">
			<div class="gnb-title">
				<a href="${pageContext.request.contextPath}/store/list.do" class="gnbBtn hvr-fade">쇼핑</a>
				<img src="/huimyoelag/upload/ico_arrow02.png" alt="화살표" />
			</div>

			<ul class="gnb-list">
				<li><a class="hvr-fade" href="${pageContext.request.contextPath}/store/list.do?category=1">리빙</a></li>
				<li><a class="hvr-fade" href="${pageContext.request.contextPath}/store/list.do?category=2">사료</a></li>
				<li><a class="hvr-fade" href="${pageContext.request.contextPath}/store/list.do?category=3">패션</a></li>
			</ul>
