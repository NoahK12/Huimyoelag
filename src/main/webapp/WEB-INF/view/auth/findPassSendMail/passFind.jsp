...
<link href="${pageContext.request.contextPath}/css/mail/findPassSendMail/passFind.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/mail/findPassSendMail/passFind.js"></script>
